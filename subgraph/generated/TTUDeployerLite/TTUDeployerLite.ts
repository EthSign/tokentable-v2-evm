...
export class TTUDeployerLite__deployTTSuiteResult {
    value0: Address
    value1: Address
    value2: Address
...
export class TTUDeployerLite extends ethereum.SmartContract {
    static bind(address: Address): TTUDeployerLite {
        return new TTUDeployerLite('TTUDeployerLite', address)
    }
    ...
    deployTTSuite(
    ...
    ): TTUDeployerLite__deployTTSuiteResult {
        let result = super.call(
            'deployTTSuite',
        ...
        return new TTUDeployerLite__deployTTSuiteResult(
            result[0].toAddress(),
            result[1].toAddress(),
            result[2].toAddress()
        )
    ...
    try_deployTTSuite(
        ...
        disableAutoUpgrade: boolean,
        allowTransferableFT: boolean
    ): ethereum.CallResult<TTUDeployerLite__deployTTSuiteResult> {
        let result = super.tryCall(
            'deployTTSuite',
            'deployTTSuite(address,string,bool,bool):(address,address,address)',
            [
        ...
        return ethereum.CallResult.fromValue(
            new TTUDeployerLite__deployTTSuiteResult(
                value[0].toAddress(),
                value[1].toAddress(),
                value[2].toAddress()
            )
