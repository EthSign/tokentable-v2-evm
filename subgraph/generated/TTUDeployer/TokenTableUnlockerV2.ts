...
export class DisableCancelFunctionCall extends ethereum.Call {
    get inputs(): DisableCancelFunctionCall__Inputs {
        return new DisableCancelFunctionCall__Inputs(this)
    }

    get outputs(): DisableCancelFunctionCall__Outputs {
        return new DisableCancelFunctionCall__Outputs(this)
    }
}

export class DisableCancelFunctionCall__Inputs {
    _call: DisableCancelFunctionCall

    constructor(call: DisableCancelFunctionCall) {
        this._call = call
    }
}

export class DisableCancelFunctionCall__Outputs {
    _call: DisableCancelFunctionCall
